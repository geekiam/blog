...
<template>
    ...
    <div
      ...
      <div class="w-full md:w-2/3 flex flex-col space-y-2 p-3">
        ...
        <p class="md:text-lg text-gray-200 text-base mb-5">An exploration into the greatest economic and political transition in
        ...
        <button type='button'
          ...
          <div class='m-auto'>
            <div class='flex items-center justify-start flex-1 space-x-4'>
              ...
              <a href="https://amzn.to/45EaivZ" class='font-medium'>Buy Now</a>
            </div>
          </div>
        </button>
      </div>
